...
public class AccountFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        SharedPreferencesService sharedPreferencesService = new SharedPreferencesService(layoutInflater.getContext());

        final Token token = new Token(sharedPreferencesService.getToken());

        final HttpClientService service = HttpClientServiceCreator.createService(HttpClientService.class);
    ...
    private void updateUser(final View view, HttpClientService service, Token token) {
        ...
        if (password.equals(repassword)) {
            ...
            call.enqueue(new Callback<ResponseDataSimple<String>>() {
                ...
                @Override
                public void onResponse(Call<ResponseDataSimple<String>> call, Response<ResponseDataSimple<String>> response) {
                    if (response.isSuccessful()) {
                        ...
                        ToastMessageUtil.toastMessage(layoutInflater, "Usuário atualizado com sucesso!!!");
                    }
                }
            ...
            ToastMessageUtil.toastMessage(layoutInflater, "As senhas não são iguais!!!");
        }
    }
        ...
        call.enqueue(new Callback<ResponseDataSimple<User>>() {
            ...
            public void onResponse(@NonNull Call<ResponseDataSimple<User>> call, @NonNull Response<ResponseDataSimple<User>> response) {
                if (response.isSuccessful()) {
                    ...
                    txtViewName.setText(userResponse.getData().getName());
